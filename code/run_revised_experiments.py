"""Master entry point for revised manuscript experiments."""
...
REVISED_RESULTS = [
    ...
    "favorable_probability_vs_g_rel.csv",
    "favorable_probability_vs_r_sep.csv",
    "favorable_predictor_ranges.csv",
    "support_overlap_analysis.csv",
    "support_overlap_positive_probability.csv",
...
REVISED_FIGURES = [
    ...
    "favorable_probability_vs_g_rel",
    "favorable_probability_vs_r_sep",
    "support_overlap_vs_A_Huff",
    "support_overlap_positive_probability",
    "favorable_sweep_heatmap",
    "favorable_probability_vs_grel",
    "favorable_probability_vs_rsep",
...
def main() -> None:
    ...
    sync_to_paper()
    print(f"synced revised outputs to {PAPER_DATA}")
